...
$('.edit').each(function(){
  ...
  <div data-page="form" class="page no-toolbar no-navbar">
	...
	<div class="navbarpages navbarpagesbg">
     ...
     <div id="pages_maincontent">
              ...
              <h2 class="page_title">Section </h2> 
     ...
     <div class="page_single layout_fullwidth_padding" ng-show = "IsVisible">
                ...
                <form class="" name="empForm" method="post" action="{{url('add_section')}}" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
			
		<div class="form-group" >
  <label for="usr">Branch:</label>
  <input type="text" class="form-control" name="branch"  ng-model="branch"  required>
  ...
  <ul class="dropdown-menu">
    <li><a href="#" class="edit" id="{{$section[$i]->sec_id}}"><font color="blue"> Edit</font></a></li>
    <li><a href="#" class="delete" id="{{$section[$i]->sec_id}}"><font color="red">DELETE </font></a></li>
  </ul>
</div>
