  ...
  <div data-page="form" class="page no-toolbar no-navbar">
	...
	<div class="navbarpages navbarpagesbg">
     ...
     <div class="page_single layout_fullwidth_padding" >
          ...
          <form class="" name="empForm" method="post" action="{{url('update_student')}}" enctype="multipart/form-data">
			
			{{--<input type="hidden" name="id" value="{{$student[0]->stu_id}}">  --}}
					<input type="hidden" name="_token" value="{{csrf_token()}}">
					<div class="form-group" >
  <label for="usr">Registration no:</label>
  <input type="text" class="form-control" name="reg_no"  value="" readonly required> 
...
<div class="form-group" >
  <label><input type="radio" name="paytype" value="1" checked>One Month </label>
...
<div class="radio">
  <label><input type="radio" name="paymode" value="1" checked>Cash</label>
