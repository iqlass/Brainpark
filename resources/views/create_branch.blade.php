...
{{Session::forget('status')}}
  ...
  <div data-page="form" class="page no-toolbar no-navbar">
	...
	<div class="navbarpages navbarpagesbg">
     ...
     <div id="pages_maincontent">
              ...
              <h2 class="page_title">Add Branch </h2> 
     ...
     <div class="page_single layout_fullwidth_padding" ng-show = "IsVisible">
                ...
                <form class="" name="empForm" method="post" action="{{url('add_branch')}}" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				<div class="form-group" >
  <label for="usr">Branch Name:</label>
  <input type="text" class="form-control" name="b_name"  ng-model="b_name"  required>
  ...
  <ul class="dropdown-menu">
    <li><a href="#" class="branch_edit" id="{{$sql[$i]->branch_id}}"><font color="blue"> Edit</font></a></li>
    <li><a href="#" class="branch_delete" id="{{$sql[$i]->branch_id}}"><font color="red">DELETE </font></a></li>
