...
$('.student_edit').each(function(){
  ...
  <div data-page="form" class="page no-toolbar no-navbar">
   ...
   <form class="" name="empForm" method="post" action="{{url('update_emp')}}" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				<input type="hidden" name="id" value="{{$sql[0]->emp_id}}">
				<div class="form-group" >
  <label for="usr">Name:</label>
  <input type="text" class="form-control" name="e_name"  ng-model="e_name" ng-value="'{{$sql[0]->emp_name}}'" required>

</div>
<div class="form-group">
  <label for="usr">Designation:</label>
  <input type="text" class="form-control" name="d_designation" ng-model="emp_designation"  ng-value="'{{$sql[0]->emp_name}}'" required>
</div>
<div class="form-group">
  <label for="usr">Birthday:</label>
  <!-- <input id="datepicker" /> -->
 <input type="text" class="form-control" name="d_dob" ng-model="d_dob" ng-model="emp_dob"  ng-value="'{{$sql[0]->emp_dob}}'" required>
</div>
...
<div class="form-group">
  ...
  <input type="text" class="form-control" name="d_address" ng-model="d_address" ng-value="'{{$sql[0]->emp_address}}'"  required>
</div>
<div class="form-group">
  <label for="usr">Phone:</label>
  <input type="number" class="form-control" name="d_mob" ng-model="d_mob" ng-value="'{{$sql[0]->emp_mobile}}'"    required>
</div>
<div class="form-group">
  <label for="usr">Email:</label>
  <input type="email" class="form-control" name="d_email" ng-model="d_email" ng-value="'{{$sql[0]->emp_email}}'"   >
</div>
<div class="form-group">
  <label for="usr">Username:</label>
  <input type="text" class="form-control" name="d_username" ng-model="d_username"  ng-value="'{{$sql[0]->emp_username}}'"  required>
</div>
<div class="form-group">
  <label for="usr">Password:</label>
  <input type="password" class="form-control" name="d_pwd" ng-model="d_pwd" ng-value="'{{$sql[0]->emp_pwd}}'"  required>
</div>
 <div class="custom-file">
 
    <label class="custom-file-label" for="customFile">Photo </label>
	   <input type="file" class="custom-file-input" name="e_img" ng-model="e_img"  >
  </div>
  <img src="../{{$sql[0]->emp_photo}}" width="150px" height="150px">
  <br>
