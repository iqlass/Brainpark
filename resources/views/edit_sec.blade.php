...
$('.student_edit').each(function(){
  ...
  <div data-page="form" class="page no-toolbar no-navbar">
	...
	<div class="navbarpages navbarpagesbg">
     ...
     <form class="" name="empForm" method="post" action="{{url('update_sec')}}" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
				<input type="hidden" name="id" value="{{$data[0]->sec_id}}">
		<div class="form-group" >
  <label for="usr">Section:</label>
  <input type="text" class="form-control" name="section"  value="{{$data[0]->sec_name}}"  required>
