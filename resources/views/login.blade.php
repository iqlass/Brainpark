...
<head>
    ...
    <title>Art Sport - The Fine Arts Center</title>
...
<div class="wrapper fadeInDown">
  <div id="formContent">
    <!-- Tabs Titles -->
@if($msg = Session::get('user_data'))
	<script>
  $.growl.error({ message: "Invalid User Name And Password" });
</script>
	@endif
	{{Session::forget('user_data')}}
    <!-- Icon -->
    <div class="fadeIn first">
    <h1><font color="#ff1d2b"> Login</font></h1>
    </div>

    <!-- Login Form -->
    <form method="POST" action="{{url('login_valid')}}">
