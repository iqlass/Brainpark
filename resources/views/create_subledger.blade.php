  ...
  <div data-page="form" class="page no-toolbar no-navbar">
	...
	<div class="navbarpages navbarpagesbg">
     ...
     <div class="page_single layout_fullwidth_padding" ng-show = "IsVisible">
                ...
                <form class="" name="empForm" method="post" action="{{url('add_subledger')}}" enctype="multipart/form-data">
				<input type="hidden" name="_token" value="{{csrf_token()}}">
					<div class="form-group" >
  <label for="usr">ledger :</label>
   <select class="form-control" id="sel1" name="ledger"  ng-model="ledger"   required>
...
<div class="form-group" >
  <label for="usr">Subledger Name:</label>
  <input type="text" class="form-control" name="sub_name"  ng-model="sub_name"  required>
    ...
    <tbody>
	 @for($i=0;$i<count($subledger);$i++)
      <tr>
        ...
        <td>{{$subledger[$i]->ledger_name}}</td>
        <td>{{$subledger[$i]->subledger_name}}</td>
  ...
  <ul class="dropdown-menu">
    <li><a href="#" class="subledger_edit" id="{{$subledger[$i]->subledger_id}}"><font color="blue"> Edit</font></a></li>
    <li><a href="#" class="subledger_delete" id="{{$subledger[$i]->subledger_id}}"><font color="red">DELETE </font></a></li>
